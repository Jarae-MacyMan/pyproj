...
def test_dump_handles_oserror(mocker):
    """
    pgdump.dump returns a reasonable error if pg_dump isn'tinstalled.
    """
...
def test_dump_file_name_without_timestamp():
    """
    pgdump.dump_file_name return the name of the db
    """
    assert pgdump.dump_file_name(url) == "db_one.sql"

def test_dump_file_name_with_timestamp():
    """
    pgdump.dump_file returns the name of the db with timestamp
    """
